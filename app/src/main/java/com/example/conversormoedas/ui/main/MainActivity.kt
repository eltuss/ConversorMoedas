package com.example.conversormoedas.ui.main
...
import com.example.conversormoedas.core.extensions.*
...
import com.example.conversormoedas.ui.history.HistoryActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun success(it: MainViewModel.State.Success) {
        ...
        val result = it.exchange.bid * binding.tilValue.text.toDouble() // Aqui mostra o resultado da conversão

        val nome1 = it.exchange.name.split('/')

        Log.e("valor-nome:", nome1[0])   // log de exemplo
        Log.e("valor:", it.exchange.bid.toString())

        binding.nomeMoeda1.text = nome1[0] // nome da moeda 1
        binding.nomeMoeda2.text = nome1[1] // nome da moeda 2

        binding.valor.text = it.exchange.bid.toString() // cotação atual da moeda 2
